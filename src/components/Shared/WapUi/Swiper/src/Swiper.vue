<template>
  <div class="wap-swiper" :class="{horizontal: direction == 'horizontal', vertical: direction == 'vertical'}">
    <div class="default-swiper-box" :style="dragStyleObject" ref="boxRef" @touchstart.stop.prevent="onTouchStart($event)" @mousedown.stop.prevent="onTouchStart($event)" @touchmove.stop.prevent="onTouchMove($event)" @mousemove.stop.prevent="onTouchMove($event)" @touchend.stop.prevent="onTouchEnd($event)" @mouseup.stop.prevent="onTouchEnd($event)" @mouseleave.stop.prevent="onTouchEnd($event)">
      <slot></slot>
    </div>
